package co.tylermaxwell.johnadmin.services;
...
import co.tylermaxwell.johnadmin.repositories.UserRepository;
...
public class UserService {
    ...
    public User adminlogin(@Valid LoginUser newLogin, BindingResult result, HttpSession session) {
        User user = getOneUserById((Long)session.getAttribute("userId"));
        System.out.println(user);
        result.rejectValue("email", "AdminEmail", "you are not admin");
